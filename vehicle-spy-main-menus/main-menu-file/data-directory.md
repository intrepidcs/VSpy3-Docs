...
\
Notice that the files in a user's data directory will also be displayed in the Vehicle Spy [Logon](../../basic-operation-of-vehicle-spy/the-logon-screen.md). It is possible to easily browse through and access files there as well.
