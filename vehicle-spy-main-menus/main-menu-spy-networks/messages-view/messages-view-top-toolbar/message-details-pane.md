...
2. Click on the message to decode so it's highlighted green in the Messages view.
3. Open the Details pane by clicking the **Details** button.\
   \--------
4. Select what signal type it might be. (analog, digital, etc...see examples here)
...
10. Click **Add Signal** to add it to the Messages Editor Receive table.
...
To set up a Tracking Signal click the **Tracking Signal** button. Use the Expression Builder to select a known signal. For example, this might be a signal value from a diagnostic job. Click **Ok** to close the Expression Builder then enable the Tracking Signal checkbox. The Tracking Signal will now be shown on the plot as a useful visual reference to adjust your unknown signal towards.
