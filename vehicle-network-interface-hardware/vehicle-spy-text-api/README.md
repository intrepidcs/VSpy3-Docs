...
| as                                                  | Accesses the collection of Application Signals. See the topic on [Collection Objects](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#COLLECTION).                                  |                                                                                                                        |
| as(index or key)                                    | Accesses a specific application signal by an index or a key. Set the topic on [Signal](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#SIGNAL) objects.                             |                                                                                                                        |
...
| fb                                                  | Accesses the collection of Function Blocks. See the topic on [Collection Objects](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#COLLECTION).                                      | fb.count? ;asks for the number of function blocks                                                                      |
| fb(index or key)                                    | Accesses a specific function block by an index or a key. Set the topic on [function block](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#FBLOCK) objects.                         | <p>fb(1).start ;starts the first function block.<br><br>fb(tst2).stop ;stops the function block with key tst2.</p>     |
...
| ui                                                  | Controls the user interface of neoVI PRO. Described in a [separate topic](https://cdn.intrepidcs.net/support/VehicleSpy/AAneoui.htm).                                                         |                                                                                                                        |
| Root Objects for Hardware                           |                                                                                                                                                                                               |                                                                                                                        |
| ao                                                  | Accesses a specific [analog outputs](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#ANALOGOUT) by an index or a key. See the topic on transmit message objects.                    | ao(0).value 3.42                                                                                                       |
...
| J1939dm1src(address)                                | [J1939 Object](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#J1939Root); also returns list of DTCs for specified address                                                          | j1939dm1src(0)?                                                                                                        |
| Root Objects for Messages                           |                                                                                                                                                                                               |                                                                                                                        |
| mg                                                  | Accesses the collection of Messages. See the topic on[ Collection Objects](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#COLLECTION).                                             |                                                                                                                        |
| mg(index or key)                                    | Accesses a specific [message object](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#MSG) by an index or a key. See the topic on message objects.                                   | mg(0).clearstats ;clears the stats of first msg                                                                        |
| tx                                                  | Accesses the collection of Transmit Messages. See the topic on [Collection Objects](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#COLLECTION).                                    | tx.additem ;adds a message at the end of the collection                                                                |
...
| ecu                                                 | Accesses the ecu subobject. This is discussed in a [separate topic](https://cdn.intrepidcs.net/support/VehicleSpy/AAgm.htm).                                                                  |                                                                                                                        |
...
| sg                                                 | Accesses the collection of Signals. See the topic on [collection objects](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#COLLECTION).              |                                                                                                               |
| sg(index or key)                                   | Accesses a specific [Signal object](https://cdn.intrepidcs.net/support/VehicleSpy/spyAApi.htm#SIGNAL) by an index or a key. See the topic on message objects. | sg(0).value? ;Asks for the Value of the first signal                                                          |
